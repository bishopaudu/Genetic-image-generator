...
use crate::{crossover::create_next_generation, display::{canvas_to_buffer, print_progress, side_by_side_buffer}, fitness::fitness_percentage, image_canvas::{Genome, random_population}, image_render::{blank_canvas, render, save_image}, mutation::mutate_population, tournamant_selection::{get_elite, score_population, select_parents}};
